...
export default async function DashboardPage() {
  ...
  return (
    <main className="flex-1 p-8 max-w-2xl mx-auto flex flex-col gap-8">
      ...
      <section className="rounded-xl border border-brand-soft bg-brand-soft/10 p-6 flex flex-col items-center gap-2">
      ...
      <section className="rounded-xl border border-brand-soft p-6">
        ...
        <form action={updateSettings} className="flex flex-wrap gap-4 items-end">
          <label className="flex flex-col gap-1 text-sm">
            ...
            <input
              ...
              className="rounded-md border border-brand-soft bg-bg px-3 py-2 w-32"
            />
          </label>
          <label className="flex flex-col gap-1 text-sm">
            취침 시각
